...
///
/// The parameter wins; otherwise `BVX_WORKSPACE`, then the working directory —
...
private func resolveWorkspace(_ path: String?) -> String {
    ...
    if let env = ProcessInfo.processInfo.environment["BVX_WORKSPACE"] { return env }
...
struct BVXShortcuts: AppShortcutsProvider {
