...
public final class Tutorial: ObservableObject {
    ...
    private let defaultsKey = "bvx.tutorial.completed"
    ...
    public static let sections: [TutorialSection] = [
        TutorialSection(
            ...
            body: """
                bvx runs **bv's own Go engine** in-process. Every metric you see
                ...
                What bvx adds is a native surface: real tables, real charts, a
        ...
        TutorialSection(
            ...
            terminalKey: "t",
            body: """
                bvx reads the git object store directly rather than shelling
        ...
        TutorialSection(
            ...
            body: """
                ...
                - **`bvx://open?workspace=…&bead=…`** opens a workspace and
                ...
                - **Install Command Line Tool…** links `bvx-cli`, which speaks
