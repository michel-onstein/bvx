...
// bvx-cli speaks bv's robot protocol.
//
...
func usageText() -> String {
    var lines = [
        "bvx-cli — bv's robot protocol, over the bvx engine",
        "",
        "USAGE:",
        "  bvx-cli --robot-<command> [--path PATH] [--format json|toon] [options]",
        "",
        "COMMANDS:",
    ]
...
func run() async -> Int32 {
    ...
    do {
        ...
        complain("Run bvx-cli --help for the command list.")
        return 2
    } catch {
