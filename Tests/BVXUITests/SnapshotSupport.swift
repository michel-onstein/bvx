...
enum Snapshot {
    ...
    static var outputDirectory: URL {
        let dir =
            ProcessInfo.processInfo.environment["BVX_SNAPSHOT_DIR"].map(URL.init(fileURLWithPath:))
            ?? URL(fileURLWithPath: NSTemporaryDirectory()).appendingPathComponent("bvx-snapshots")
